# DeFi Stablecoin $KpUSD


[KpDSCEngine Example](https://sepolia.etherscan.io/address/0x091ea0838ebd5b7dda2f2a641b068d6d59639b98#code)
...
```
git clone https://github.com/Elite-Oracle/Decentral-Stable-Coin.git
cd Decentral-Stable-Coin
forge build
```
...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#github.com/Elite-Oracle/Decentral-Stable-Coin)
...
3. Deposit and Mint kpDSC

```
cast send 0x091EA0838eBD5b7ddA2F2A641B068d6D59639b98 "depositCollateralAndMintkpDSC(address,uint256,uint256)" 0xdd13E55209Fd76AfE204dBda4007C227904f0a81 100000000000000000 10000000000000000 --rpc-url $SEPOLIA_RPC_URL --private-key $PRIVATE_KEY
```
